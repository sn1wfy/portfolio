document.addEventListener('DOMContentLoaded', function () {
  ...
  if (languageToggle) {
    languageToggle.addEventListener('click', () => {
      ...
      const isBulgarian = currentPath.includes('/bg/');
      const isEnglish = currentPath.includes('/en/');
      
      if (isBulgarian) {
        // Switch to English version
        const englishPath = currentPath.replace('/bg/', '/en/');
        window.location.href = englishPath;
      } else if (isEnglish) {
        // Switch to Bulgarian version
        const bulgarianPath = currentPath.replace('/en/', '/bg/');
        window.location.href = bulgarianPath;
      } else {
        // Default case - redirect to Bulgarian
